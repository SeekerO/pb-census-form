...
const HouseProfileINSERT = async (data: any) => {
    ...
    const { houseprofileid, nofammembers, housenumber, bcno, street, subd, km, blk, lot, phase } = data;
...
const LocationINSERT = async (data: any) => {
    const { houseprofileid, housenumber, bcno, street, subd, km, blk, lot, phase } = data;
    // INSERT DATABASE METHOD HERE
    return true;
};
